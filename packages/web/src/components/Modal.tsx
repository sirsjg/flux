...
export function Modal({
  ...
  return (
    ...
    >
      ...
      >
        <div class="flex items-start justify-between gap-4 px-6 pt-5 pb-4 border-b border-base-200">
          <div class="min-w-0">
        ...
        <div class="px-6 py-5 overflow-y-auto flex-1 min-h-0">{children}</div>
      </div>
    </dialog>
  )
}
