...
app.post('/api/projects', requireServerAccess, async (c) => {
  ...
  syncService.recordChange('project', project.id, 'create', project as unknown as Record<string, unknown>);
...
app.patch('/api/projects/:id', requireServerAccess, async (c) => {
  ...
  syncService.recordChange('project', project.id, 'update', project as unknown as Record<string, unknown>);
...
app.delete('/api/projects/:id', requireServerAccess, (c) => {
  ...
  if (project) {
    syncService.recordChange('project', project.id, 'delete', project as unknown as Record<string, unknown>);
...
app.post('/api/projects/:projectId/epics', async (c) => {
  ...
  syncService.recordChange('epic', epic.id, 'create', epic as unknown as Record<string, unknown>);
...
app.patch('/api/epics/:id', async (c) => {
  ...
  syncService.recordChange('epic', epic.id, 'update', epic as unknown as Record<string, unknown>);
...
app.delete('/api/epics/:id', (c) => {
  ...
  syncService.recordChange('epic', epicId, 'delete', epic as unknown as Record<string, unknown>);
...
app.post('/api/projects/:projectId/tasks', async (c) => {
  ...
  syncService.recordChange('task', task.id, 'create', task as unknown as Record<string, unknown>);
...
app.patch('/api/tasks/:id', async (c) => {
  ...
  if (!task) return c.json({ error: 'Task not found' }, 404);
  syncService.recordChange('task', task.id, 'update', task as unknown as Record<string, unknown>);
