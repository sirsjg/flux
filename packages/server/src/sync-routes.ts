...
import type { SyncEnvelope } from '@flux/shared/sync-types';
 ...
 */
export function registerSyncRoutes(app: Hono<{ Variables: { auth: AuthContext } }>): void {
  ...
  app.post('/api/sync/push', async (c) => {
    ...
    const changes = body.changes as SyncEnvelope[];
