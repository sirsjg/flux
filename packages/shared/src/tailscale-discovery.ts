...
import type { TailscalePeer, PeerState } from './sync-types.js';
...
type TailscaleStatus = {
  Self: TailscalePeer & { Tags?: string[] };
  Peer: Record<string, TailscalePeer & { Tags?: string[] }>;
};
...
async function probePeer(
  ...
  const syncStatus = await fetchJson<SyncStatusResponse>(
